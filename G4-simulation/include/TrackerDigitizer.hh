...
#ifndef TRACKERDIGITIZER_HH_
#define TRACKERDIGITIZER_HH_
...
class TrackerDigitizer : public G4VDigitizerModule
{
public:
  /*! \brief constructor
   *
   ...
   */
  //TrackerDigitizer(G4String aName, G4int hitCollID);
  TrackerDigitizer(G4String aName, G4String hitsCollName);

  //! Empty destructor
  virtual ~TrackerDigitizer() {};
...
protected:
  ...
  virtual void MakeCrosstalk(std::vector< std::vector< TrackerDigit* > >& digitsMap);
  //@}
public:
...
private:
  ...
  //TrackerDigitizerMessenger messenger;
};
